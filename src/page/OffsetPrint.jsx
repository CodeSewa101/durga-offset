...
const OffsetPrint = () => {
  ...
  useEffect(() => {
    const fetchOffsetImages = async () => {
      try {
        setLoading(true);
        const snapshot = await getDocs(collection(db, "uploads"));
        const items = snapshot.docs
          .map((doc) => ({ id: doc.id, ...doc.data() }))
          .filter((item) => item.category === "Offset Print");

        setOffsetItems(items);
        setError(null);
      } catch (err) {
        console.error("Error fetching offset prints:", err);
  ...
  const allImages = offsetItems.flatMap((item) =>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative isolate overflow-hidden bg-gradient-to-br from-[#0a192f] via-[#0f4a7a] to-[#1a759f] py-36 px-6 sm:px-10 lg:px-20 text-center">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          >
            ...
            <br />
            <span className="text-white">For Business Excellence</span>
          </motion.h1>
          ...
          >
            High-quality offset printing services for brochures, catalogs, business cards, and all your professional printing needs.
          </motion.p>
      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            High-quality offset prints with vibrant colors and sharp details
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white rounded-xl shadow-sm max-w-md mx-auto p-8">
            ...
            <p className="text-gray-600 mb-6">We couldn't find any offset print designs at the moment</p>
            <button
              onClick={() => window.location.reload()}
              className="px-6 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors"
            >
          ...
          <div className="max-w-5xl w-full bg-white rounded-xl overflow-hidden shadow-2xl">
            <div className="relative">
              ...
              <img
                ...
                alt="Enlarged offset print design"
              />
            </div>
            <div className="p-6">
      ...
      <div className="bg-gradient-to-br from-[#0a192f] to-[#1a759f] py-16 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-3xl font-bold text-white mb-4">Ready for Professional Offset Printing?</h3>
          <p className="text-xl text-white/90 mb-8">
            Let us bring your designs to life with premium quality offset printing
          </p>
          <motion.button
            whileHover={{
              scale: 1.05,
