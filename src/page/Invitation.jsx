      ...
      <div className="relative isolate overflow-hidden bg-gradient-to-br from-[#0a192f] via-[#0f4a7a] to-[#1a759f] py-36 px-6 sm:px-10 lg:px-20 text-center">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          >
            ...
            <br />
            <span className="text-white">For Your Special Occasions</span>
          </motion.h1>
          ...
          >
            Create unforgettable first impressions with our premium invitation cards, perfect for weddings, birthdays, and all your special events.
          </motion.p>
